...
const RightContent3 = ({ content }) => {
  return (
    <div className="right-content">
      ...
      <p className='pExtraStyle2'>Tasse Kaffee<sup>8</sup><span className='spanStyle'>2,00</span><span className='spanStyle'>&nbsp; </span></p>
      <p>Bier alle Sorten<sup>g</sup><span className='spanStyle'>3,00</span><span className='spanStyle'>0,5l&nbsp; </span></p>
      <p className='pExtraStyle2'>Bier alle Sorten<sup>g</sup><span className='spanStyle'>2,70</span><span className='spanStyle'>0,33l&nbsp; </span></p>
